...
New-AzVirtualNetwork -Name vnet-pg-hub -ResourceGroupName $resourceGroup -Location $location -AddressPrefix "10.0.0.0/16" -Subnet $frontendSubnet,$backendSubnet
...
New-AzVirtualNetwork -Name vnet-pg-identity -ResourceGroupName $resourceGroup -Location $location -AddressPrefix "10.1.0.0/16" -Subnet $frontendSubnet,$backendSubnet
